...
import static com.smartloan.smtrick.smart_loan_user.constants.Constant.REQUEST_CODE;
...
//                textViewAgentId.setText(appSharedPreference.getAgeniId());
    ...
    public class ImageUploadReceiver extends BroadcastReceiver {
        public static final String PROCESS_RESPONSE = "com.smartloan.smtrick.smart_loan_user.intent.action.UPDATE_USER_DATA";
