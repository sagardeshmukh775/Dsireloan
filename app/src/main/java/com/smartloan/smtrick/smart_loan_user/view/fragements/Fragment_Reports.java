...
import com.smartloan.smtrick.smart_loan_user.databinding.FragmentReportBinding;
...
import com.smartloan.smtrick.smart_loan_user.view.adapters.ReportLeedsAdapter;
...
import static com.smartloan.smtrick.smart_loan_user.constants.Constant.CALANDER_DATE_FORMATE;
...
public class Fragment_Reports extends Fragment {
    ...
    private void getteLeed() {
        ...
        leedRepository.readLeedsByUserIdReport(getActivity(),appSharedPreference.getAgeniId(), new CallBack() {
            @Override
